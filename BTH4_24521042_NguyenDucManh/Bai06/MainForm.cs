...
namespace Bai06
{
    public partial class MainForm : Form
    {
        ...
        private void backgroundWorker_Copy_ProgressChanged(object sender, ProgressChangedEventArgs e)
        {
            ...
            toolStripLabel_Status.Text = "Đang sao chép: " + fname;
            toolTip_Status.SetToolTip(toolStrip_Status, toolStripLabel_Status.Text);
        ...
        {
            toolStripLabel_Status.Text = "Hoàn tất sao chép";
