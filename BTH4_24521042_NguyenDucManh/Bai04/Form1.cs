...
namespace Bai04
{
    public partial class Form1 : Form
    {
        ...
        private void NewFile()
        {
            ...
            ComboBox_Font.Text = fontDefault.FontFamily.Name;
            ComboBox_Size.Text = fontDefault.Size.ToString();
            activeBtn(toolStripButton_Bold, false);
            activeBtn(toolStripButton_Italic, false);
            activeBtn(toolStripButton_Underline, false);
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                styleFont = f.Style;
                ComboBox_Font.Text = f.FontFamily.Name;
                ComboBox_Size.Text = f.Size.ToString();
            }
